...
async def process_cv(
    ...
    if file_size_exceeds_limit(cv, settings.MAX_UPLOAD_FILE_SIZE_BYTES):
    ...
    try:
        ...
        vacancies = await vacancy_service.fetch_filtered_vacancies(
            http_client, search_filters, limit=settings.MAX_VACANCIES_PER_SOURCE
        )
